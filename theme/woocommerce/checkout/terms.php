...
if (apply_filters('woocommerce_checkout_show_terms', true) && function_exists('wc_terms_and_conditions_checkbox_enabled')) {
	...
	<div class="woocommerce-terms-and-conditions-wrapper">
		<div class="divider m-0 h-px"></div>
		...
		<?php if (wc_terms_and_conditions_checkbox_enabled()): ?>
			<div class="divider mt-0 h-px"></div>

			<p class="text-sm mb-4 form-row validate-required">
				<label class="woocommerce-form__label woocommerce-form__label-for-checkbox">
					<input type="checkbox"
						class="woocommerce-form__input woocommerce-form__input-checkbox input-checkbox checkbox checkbox-xs checkbox-info"
