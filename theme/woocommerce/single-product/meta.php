...
global $product;
?>
<div class="product_meta mb-2 flex flex-col">
	...
	<?php echo wc_get_product_category_list($product->get_id(), ', ', '<span class="posted_in *:text-accent">' . _n('Category:', 'Categories:', count($product->get_category_ids()), 'woocommerce') . ' ', '</span>'); ?>
