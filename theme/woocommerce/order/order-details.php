...
<section class="woocommerce-order-details">
	...
	<h2 class="text-xl mt-8 mb-2 font-bold woocommerce-order-details__title">
		<?php esc_html_e('Order details', 'woocommerce'); ?>
	</h2>

	<table class="max-w-md mb-8 table woocommerce-table woocommerce-table--order-details shop_table order_details">
